> ## ⚠️ هذا الملف لم يعد صالحاً
>
> يشرح النشر بأن تسحب الاستضافة من GitHub — وقد أثبت فحص `probe.php` أن
> **AwardSpace تحجب كل اتصال صادر خارج خادمها**، فلا `deploy.php` يصل إلى GitHub
> ولا البوابة تقرأ مصدر الإجازات الخارجي.
>
> **الطريقة المعتمدة الآن في [DEPLOY-FTP.md](DEPLOY-FTP.md)** — GitHub يدفع عبر FTP.
>
> ما يبقى صالحاً هنا: استيراد `db/schema.sql`، وروابط `index.php?action=install|sync`،
> وجدول الأعطال في آخر الملف.
